...
def instagram_login():
    ...
    driver.find_element(By.XPATH, '/html/body/div[1]/div/div/div[2]/div/div/div[1]/div[1]/div/section/main/article/div[2]/div[1]/div[2]/div/form/div/div[1]/div/label/input').send_keys(os.getenv('INSTAGRAM_EMAIL'))
    driver.find_element(By.XPATH, '/html/body/div[1]/div/div/div[2]/div/div/div[1]/div[1]/div/section/main/article/div[2]/div[1]/div[2]/div/form/div/div[2]/div/label/input').send_keys(os.getenv('INSTAGRAM_PASSWORD'))
    driver.find_element(By.XPATH, '/html/body/div[1]/div/div/div[2]/div/div/div[1]/div[1]/div/section/main/article/div[2]/div[1]/div[2]/div/form/div/div[3]').click()
...
def follow_accounts():
    ...
    driver.find_element(By.XPATH, '/html/body/div[2]/div/div/div[2]/div/div/div[1]/div[2]/div/div[1]/section/main/div/header/section/div[2]/ul/li[2]/div/a').click()
    time.sleep(1)

    # followers of the source account pop up in a new window
    follower_window = driver.find_element(By.XPATH, '/html/body/div[6]/div[1]/div/div[2]/div/div/div/div/div[2]/div/div')
    time.sleep(1)
    # for the break condition
    last_follower = None
    while True:
        followers = follower_window.find_elements(By.TAG_NAME, "button")
